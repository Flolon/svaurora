...
function getSVAnnounce() {
    ...
    xhr.onload = function (e) {
        if (xhr.responseText != "\n") {
            ...
            document.getElementsByTagName("body")[0].innerHTML = '<br><br><br><div id="announce" style="text-align:center;background-color:#ffae00;word-wrap:break-word;padding:15px;"><h2>' + tmp['title'] + '</h2>' + tmp['content'] + '</div>' + tmp['learnmore'] + document.getElementsByTagName("body")[0].innerHTML;
        }
    }
}
